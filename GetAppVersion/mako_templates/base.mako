...
<head>
	...
	<link rel="shortcut icon" href="${STATIC_URL}index/favicon.ico" type="image/x-icon">
	<!-- bootstrap css -->
	    ...
	    <div class="container" style="width: 100%;">
	        ...
	        <div class="collapse navbar-collapse navbar-responsive-collapse col-md-8 col-sm-8 col-xs-8" id="king-example-navbar-collapse-2" style="float:right;">
	            <ul class="nav navbar-nav" style="float:right;">
					...
					<li class="${dev_guide}"><a href="${SITE_URL}mako/dev-guide/"><span>开发指引</span></a></li>
    ...
    <div class="foot" id="footer">
        ...
        <ul class="links ft">
            <li>
                ...
                | <a href="${BK_URL}" target="_blank" hotrep="hp.footer.feedback" class="link">蓝鲸智云工作台</a>
            </li>
